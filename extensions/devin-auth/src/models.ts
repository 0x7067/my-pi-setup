...
const MODEL_META: Map<string, ModelMeta> = new Map([
  ...
  [
    "swe-1-7-lightning",
    {
      ...
      reasoning: true,
      input: ["text", "image"],
      cost: { input: 2.5, output: 12.5, cacheRead: 0.25, cacheWrite: 3.13 },
    },
  ],
  [
    "gpt-5-6-sol",
  ...
  [
    "gpt-5-6-luna",
    {
      ...
      reasoning: true,
      input: ["text", "image"],
      cost: { input: 1.0, output: 6.0, cacheRead: 0.1, cacheWrite: 1.25 },
    },
  ],
  [
    "gpt-5-6-terra",
    {
      ...
      reasoning: true,
      input: ["text", "image"],
      cost: { input: 2.5, output: 15.0, cacheRead: 0.25, cacheWrite: 3.13 },
    },
  ],
  [
    "claude-opus-4-8",
  ...
  [
    "glm-5-2",
    {
      ...
      reasoning: true,
      input: ["text", "image"],
      cost: { input: 0.7, output: 2.2, cacheRead: 0.26, cacheWrite: 0.88 },
    },
  ],
  [
    "kimi-k2-7",
    {
      ...
      reasoning: true,
      input: ["text", "image"],
      cost: { input: 0.95, output: 4.0, cacheRead: 0.19, cacheWrite: 1.19 },
    },
  ],
  [
    "grok-4-5",
    {
      ...
      reasoning: true,
      input: ["text", "image"],
      cost: { input: 2.0, output: 6.0, cacheRead: 0.5, cacheWrite: 2.5 },
    },
  ],
]);
...
export const FALLBACK_MODELS: ProviderModelConfig[] = [
  ...
  makeModel(
    "swe-1-7-lightning",
    "SWE-1.7 Lightning",
    MODEL_META.get("swe-1-7-lightning")!,
  ),
  ...
  makeModel(
    "claude-opus-4-8",
    "Claude Opus 4.8",
    MODEL_META.get("claude-opus-4-8")!,
  ),
  makeModel(
    "claude-fable-5",
    "Claude Fable 5",
    MODEL_META.get("claude-fable-5")!,
  ),
  makeModel(
    "claude-sonnet-5",
    "Claude Sonnet 5",
    MODEL_META.get("claude-sonnet-5")!,
  ),
